package danazone.com.visu.ui.main.tutor;
...
import danazone.com.visu.ui.main.select.SelectActivity;
...
@EFragment(R.layout.fragment_tutor)
public class TutorFragment extends BaseContainerFragment {
    @ViewById
    TextView mTvStatus;
    @ViewById
    TextView mTvClass;
